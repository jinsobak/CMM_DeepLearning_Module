...
# Pseudo-Label 부여 (다수결)
pseudo_labels_ntc = np.round((y_pred_ntc_ng_ok + y_pred_ntc_ok_ntc) / 2).astype(int)
...
# 재훈련을 위해 데이터 전처리
X_train_pseudo, X_test_pseudo, y_train_pseudo, y_test_pseudo, _ = preprocess_data(ng_data, ok_data, ntc_data, [0, 1])
