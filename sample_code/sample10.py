...
def sample_data(num_samples=10):
    ...
    측정값_원2_I_중_D = np.round(np.random.uniform(16.457, 16.514, num_samples),3)
    기준값_원2_I_중_D = np.random.choice([16.48, 16.485], num_samples)
    상한공차_원2_I_중_D = np.full(num_samples, 0.03)
    하한공차_원2_I_중_D = np.random.choice([-0.01, 0], num_samples)
    편차_원2_I_중_D = 기준값_원2_I_중_D - 측정값_원2_I_중_D
    ...
    return (측정값_평면1_평면도, 기준값_평면1_평면도, 상한공차_평면1_평면도, 하한공차_평면1_평면도, 편차_평면1_평면도,
             ...
             측정값_원2_I_중_D, 기준값_원2_I_중_D, 상한공차_원2_I_중_D, 하한공차_원2_I_중_D, 편차_원2_I_중_D)
...
(측정값_평면1_평면도1, 기준값_평면1_평면도, 상한공차_평면1_평면도, 하한공차_평면1_평면도, 편차_평면1_평면도,
  측정값_원1_I_상_D, 기준값_원1_I_상_D, 상한공차_원1_I_상_D, 하한공차_원1_I_상_D, 편차_원1_I_상_D,
  측정값_원2_I_중_D, 기준값_원2_I_중_D, 상한공차_원2_I_중_D, 하한공차_원2_I_중_D, 편차_원2_I_중_D) = sample_data(num_samples)
...
df = pd.DataFrame({
    ...
    '측정값_원2(I) <중>_D' : 측정값_원2_I_중_D,
    '기준값_원2(I) <중>_D'  : 기준값_원2_I_중_D,                                          
    '상한공차_원2(I) <중>_D' : 상한공차_원2_I_중_D,
    '하한공차_원2(I) <중>_D' : 하한공차_원2_I_중_D,                                      
    '편차_원2(I) <중>_D' : 편차_원2_I_중_D
})
